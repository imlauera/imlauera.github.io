...
**¿Por qué no usar un generador de QR online?** Hay muchos, pero todos están permitidos
a retener y guardar la información que le proporcionas, y pueden hacer lo que quieran
...
{% highlight bash %}
qrencode -s 6 -l H -o "contact.png" < contacto.txt
{% endhighlight %}
